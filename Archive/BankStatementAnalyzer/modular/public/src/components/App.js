      ...
      fileReader.onload = async (event) => {
        try {
          ...
          if (allText.trim()) {
            ...
            const processedData = window.processTransactionsWithSummary(allText, avgConfidence);
            setData(processedData);

            setProgressMessage('');
            setOcrStatus(`✅ Processing complete! Extracted and parsed ${allText.length} characters.`);
          } else {
