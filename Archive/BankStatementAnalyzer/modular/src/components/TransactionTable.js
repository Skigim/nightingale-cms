    ...
    return data.map((yearData) => ({
      ...
      months: yearData.months.map((monthData) => ({
        ...
        transactions: filterTransactions(
          sortTransactions(monthData.transactions)
        ),
      })),
    }));
  ...
  if (!data || data.length === 0) {
    return e('div', { className: 'text-center text-muted' }, [
      e(
        'p',
        { key: 'message' },
        '📄 Upload a bank statement PDF to see transactions here.'
      ),
    ]);
  }
          ...
          return e(
            ...
            [
              e('div', { className: 'month-header', key: 'header' }, [
                e(
                  'span',
                  { className: 'year-label', key: 'year' },
                  yearData.year
                ),
                e(
                  'span',
                  { className: 'month-label', key: 'month' },
                  monthData.month
                ),
                e(
                  'div',
                  ...
                  e(
                    ...
                    [
                      ...
                      e(
                        'option',
                        { value: 'debit', key: 'debit' },
                        'Debits Only'
                      ),
                      e(
                        'option',
                        { value: 'warnings', key: 'warnings' },
                        'Warnings Only'
                      ),
                    ]
                  )
              ...
              e(
                'div',
                { className: 'transactions-column', key: 'transactions' },
                [
                  ...
                  e('div', { className: 'warning-legend', key: 'legend' }, [
                    ...
                    e('div', { className: 'legend-item', key: 'parsing' }, [
                      e(
                        'span',
                        { className: 'legend-icon', key: 'icon' },
                        '❌'
                      ),
