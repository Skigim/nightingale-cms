...
function testToastSystem() {
  ...
  console.log('   window.NightingaleToast.showToast:', typeof window.NightingaleToast?.showToast);
  ...
  try {
    const result = window.showToast?.('Toast system test successful!', 'success');
