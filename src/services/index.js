...
async function loadService(servicePath) {
  return new Promise((resolve, reject) => {
    ...
    // Since this script is loaded from src/services/index.js relative to the page,
    // we need to prepend src/services/ to make paths relative to the page location
