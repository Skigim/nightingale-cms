...
const MockModal = ({ isOpen, onClose, title, size, footerContent, children }) => {
...
describe('StepperModal Component', () => {
  ...
  describe('Basic Rendering', () => {
    test('renders when isOpen is true', () => {
      ...
      expect(screen.getByTestId('modal-title')).toHaveTextContent('Test Stepper Modal');
      expect(screen.getByTestId('modal-size')).toHaveTextContent('large');
    });

    test('does not render when isOpen is false', () => {
      render(<StepperModal {...defaultProps} isOpen={false} />);
  ...
  describe('Step Navigation', () => {
    test('displays correct step numbers and checkmarks', () => {
      render(<StepperModal {...defaultProps} currentStep={2} />);
    ...
    test('applies correct styling to active step', () => {
      render(<StepperModal {...defaultProps} currentStep={1} />);
    ...
    test('applies correct styling to completed steps', () => {
      ...
      const completedStepIndicators = document.querySelectorAll('nav .bg-green-600');
  ...
  describe('Footer Navigation Buttons', () => {
    ...
    test('disables Back button on first step', () => {
      render(<StepperModal {...defaultProps} currentStep={0} />);
  ...
  describe('Focus Management', () => {
    ...
    test('calls focus manager when available', (done) => {
      ...
      setTimeout(() => {
        expect(window.NightingaleFocusManager.focusStepChange).toHaveBeenCalled();
  ...
  describe('Edge Cases', () => {
    test('handles empty steps array', () => {
      render(<StepperModal {...defaultProps} steps={[]} />);
    ...
    test('handles missing step descriptions', () => {
      ...
      render(<StepperModal {...defaultProps} steps={stepsWithoutDesc} />);
    ...
    test('handles currentStep beyond array bounds', () => {
      render(<StepperModal {...defaultProps} currentStep={10} />);
